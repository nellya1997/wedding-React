...
Так вот, что бы упростить связку фронта и бека, в package.json используется proxy.
Что бы мы могли отправить запрос на api, а браузер уже мог понимать, на какой порт его отправлять.
В данном проекте порт у меня стоит 10000, так как бесплатный хост даёт исключительно его.
По этому реакт будет писать в консоли кучу ошибок на этот счет, исправьте порт на 3001 (порт бекенда).
